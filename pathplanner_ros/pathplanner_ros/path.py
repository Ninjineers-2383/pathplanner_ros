...
class PathPlannerPath:
    ...
    def fromPathFile(path_name: str) -> PathPlannerPath:
        ...
        """
        filePath = os.path.join(get_package_share_directory(path_name.split(':')[0]), 'pathplanner', 'paths', path_name.split(':')[1] + '.path')
    ...
    def fromChoreoTrajectory(trajectory_name: str) -> PathPlannerPath:
        ...
        """
        filePath = os.path.join(get_package_share_directory(trajectory_name.split(':')[1]), 'choreo', trajectory_name.split(':')[1] + '.traj')
